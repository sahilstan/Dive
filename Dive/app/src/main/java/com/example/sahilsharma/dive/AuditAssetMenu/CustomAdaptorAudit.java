...
public class CustomAdaptorAudit extends BaseAdapter {

    Context c;
    ArrayList<AssetListDataFull> assetListDataFull;
    LayoutInflater inflater;

    public CustomAdaptorAudit(Context c, ArrayList<AssetListDataFull> assetListDataFull) {
        this.c = c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = inflater.inflate(R.layout.custom_list_view_audit, parent, false);
        }
