...
import com.example.sahilsharma.dive.AuditAssetMenu.CustomAdaptorAudit;
...
public class ParserReport extends AsyncTask<Void, Integer, Integer> {
    ...
    public ParserReport(Context c, String data, ListView lvReport) {
        this.c = c;
    ...
    protected void onPostExecute(Integer integer) {
        ...
        if(integer == 1){
            ...
            CustomAdaptorReport customAdaptorReport = new CustomAdaptorReport(c, assetListDataFull);
            lvReport.setAdapter(customAdaptorReport);
