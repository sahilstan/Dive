...
/**
 * Created by sahilsharma on 3/4/19.
 */
...
public class DownloaderAudit extends AsyncTask<Void, Integer, String> {
    ...
    public DownloaderAudit(Context c, String address, ListView lvAudit) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s != null){
            ParserAudit p = new ParserAudit(c, s, lvAudit);
            p.execute();
